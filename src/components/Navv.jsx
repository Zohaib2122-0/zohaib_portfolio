        ...
        <div className="flex justify-between h-20">
          <div className="flex">
            ...
            <div className="hidden md:flex space-x-4 ml-52 mt-4">
              <Link to={"/"} className="text-cont hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium">
                Home
              </Link>
          ...
          <div className="md:hidden flex items-center">
            <button onClick={toggleMobileMenu} className="text-cont hover:text-blue-600 focus:outline-none">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link to={"/"} className="text-cont hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium">
              Home
            </Link>

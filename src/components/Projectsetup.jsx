...
import { useDeleteprojectMutation, useGetprojectsQuery } from './redux/projectapislice'; 
      ...
      {/* Breadcrumbs */}
       <div className="mb-8  rounded-2xl bg-[#1f1f1f] ">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className={"bg-darkbg border-2 border-gray-700 text-white px-6 h-12 w-40 rounded-md m-3"}
                  >
                  Upload project
                </button>
                  </Link>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-gray-300 text-center">{proj.category}</p>
                    <button onClick={() =>handledelete(proj._id)} className='mt-10 w-16 h-8 rounded-md  text-gray-300 border-1 border-red-800 bg-red-600' disabled={deleting}>
